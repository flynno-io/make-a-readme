...
const prompts = [
    {
        name: "sections",
        type: "checkbox",
        message: "Select what sections you want to include? (sections installation, usage, credits, questions, and license are included)",
    ...
    },
    {
        ...
        type: "input",
        message: "Add the file names of the images you want in the order you want them (comma separated)\n  Note: images must be in the path /assets/images/ to show correctly",

...
function renderTableOfContents(data) {
    ...
    if (allSections.includes("Description")) {
        tableOfContents.push("- [Description](#description)");
    }
    if (allSections.includes("Installation")) {
        tableOfContents.push("- [Installation](#installation)");
    }
    if (allSections.includes("Usage")) {
        tableOfContents.push("- [Usage](#usage)");
    }
    if (allSections.includes("License")) {
        tableOfContents.push("- [License](#license)");
    }
    if (allSections.includes("Features")) {
        tableOfContents.push("- [Features](#features)");
    }
    if (allSections.includes("Testing")) {
        tableOfContents.push("- [Testing](#testing)");
    }
    if (allSections.includes("Credits")) {
        tableOfContents.push("- [Credits](#credits)");
    }
    if (allSections.includes("Sponsors")) {
        tableOfContents.push("- [Sponsors](#sponsors)");
    }
    if (allSections.includes("Contributing")) {
        tableOfContents.push("- [Contributing](#contributing)");
    }
    if (allSections.includes("Questions")) {
